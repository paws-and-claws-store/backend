...
- [Запити для продутків](#запити-для-продутків)
  ...
  - [Пошук по ключовому слову](#пошук-продуктів-по-ключовому-слову) -[Пошук товару по коду продукта](#пошук-детальної-інфорації-про-продукт-по-коду-товаку-idproduct)
- [Пагінація](#пагінація)
...
- `/api/products/pets/copy/:idProduct`
